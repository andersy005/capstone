...
# This is done by configuring the channel 2 in the PWM mode with a compare value of 
# 100 (out of period 500)
ch2 = timer.channel(2, pyb.Timer.PWM, pin=led2, pulse_width=100)